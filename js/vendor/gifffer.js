var Gifffer = function() {
    ...
    var createContainer = function(w, h, el) {
        ...
        play[sa]('style', 'width:80px;height:60px;border-radius:10px;background:rgba(0, 0, 0, 0.3);position:absolute;left:' + ((w/2)-40) + 'px;top:' + ((h/2)-30) + 'px;');
        var trngl = d.createElement('DIV');
        trngl[sa]('style', 'width:0;height: 0;border-top:18px solid transparent;border-bottom:18px solid transparent;border-left:22px solid rgba(255, 255, 255, 0.7);position:absolute;left:30px;top:12px;')
